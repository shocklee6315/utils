...
/**
 * 代码来自于github 一个high-level的反射api调用方式
 */
...
public class Reflect {
     ...
     * @throws ReflectionException If any reflection exception occurred.
     * @see #on(Class)
     */
    ...
    private Field field0(String name) throws ReflectionException {
        Class<?> type = type();
     ...
     */
    private static Reflect on(Method method, Object object, Object... args) throws ReflectionException {
        try {
            accessible(method);
